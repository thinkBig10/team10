                    ...
                    <div class="form-block-2 w-form">
                        <form
                            ...
                            <select id="field" name="field" data-name="Field" class="select-field w-select">
                                ...
                                <option value="revenueorder" selected>REVENUE ORDER</option>
                            </select>
                        </form>
                ...
                <?php
                    ...
                    if (mysqli_connect_errno()) {
                        ...
                        <div class="div-block-8 brand_rollup_block">
                            <div class="div-block-7 datarow">TOTAL</div>
                            <div class="div-block-7 productnamecol datarow">TOTAL BRAND</div>
                            <div class="div-block-7 brandnamecol datarow">FOOTWEAWR</div>
                            <div class="div-block-7 datarow">10000000000</div>
                        </div>';
